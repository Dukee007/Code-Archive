...
TOKEN = "ODUzNzAyNjg0OTUwOTIxMjM2.YMZOlQ.-sHy52r4DwOAS7vD2anPUPwxxMU"
...
async def rename(ctx):
    for channel in ctx.guild.channels:
        e = input(f"What do you to call {channel.name}? - ")
        await channel.edit(name=e)
...
async def on_ready():
    ...
    status = cycle([f"over {str(len(client.users))} users!", "youtube!", "asmr!"])
